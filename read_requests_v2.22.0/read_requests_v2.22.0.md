...
最后，细心的同学可能发现了，在前面的调试信息中，返回的url="http://127.0.0.1:62206/digest-auth/auth/user/pass"，而不是我们测试用例中的url="http://127.0.0.1:62206/digest-auth/auth/user/pass/MD5/nerver"这个样式。
